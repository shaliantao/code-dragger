...
import {
  ...
  IpcRenderer,
  WebFrame,
} from '@src/sandbox/electronTypes';
...
export const ipcRenderer: IpcRenderer = globals.smart.ipcRenderer;
export const webFrame: WebFrame = globals.smart.webFrame;
export const crashReporter: CrashReporter = globals.smart.crashReporter;
export const process: ISandboxNodeProcess = globals.smart.process;
export const context: ISandboxContext = globals.smart.context;
