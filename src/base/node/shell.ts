...
import { getFirstAvailablePowerShellInstallation } from '@base/node/powershell';
import * as processes from '@base/node/processes';
...
export function getSystemShellSync(
  os: platform.OperatingSystem,
  env: platform.IProcessEnvironment,
): string {
  if (os === platform.OperatingSystem.Windows) {
